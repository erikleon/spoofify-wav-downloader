...
2. Searches YouTube for the best matching audio using **yt-dlp**, prioritising lossless codecs (FLAC → ALAC → WAV) and highest bitrate.
3. Converts the downloaded audio to **WAV** (signed 24-bit PCM, 48 kHz stereo) using **ffmpeg**.
...
The tool prioritises audio quality in this order:
